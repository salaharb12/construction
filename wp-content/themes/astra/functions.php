...
function add_custom_menu_script() {
    // Enqueue the unminified JavaScript file
    wp_enqueue_script(
        'menu-active', // A unique handle for the script
        get_template_directory_uri() . '/assets/js/unminified/menu-active.js', // Path to the script
        array(), // Dependencies (leave empty if none)
        '1.0', // Version number
        true // Load in footer (true means it loads before </body>)
    );
}
add_action('wp_enqueue_scripts', 'add_custom_menu_script');
